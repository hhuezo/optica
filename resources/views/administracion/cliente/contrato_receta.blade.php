...
<table width="100%" border="0">
  <tr>
    <td><div align="center"><p  class="Estilo3">Dr. Rogelio Am&iacute;lcar Ch&aacute;vez Parada</p>
    </div></td>
  </tr>
  <tr>
    <td><div>
...
<table width="100%" border="0">
  <tr>
    <td class="Estilo2"><div>
      <div align="right">FECHA: {{ $contrato->date ? date('d/m/Y', strtotime($contrato->date)) : '' }}</div>
    </div></td>
  </tr>
  <tr>
    <td class="Estilo2"><div>PACIENTE: {{$contrato->cliente->name ?? ''}} {{$contrato->cliente->lastname ?? ''}}</div></td>
  </tr>
</table>
<br />
...
<table width="100%" border="0">
  <tr>
    <td class="Estilo2"><div>OBSERVACIONES:_________________________</div></td>
  </tr>
  <tr>
    <td class="Estilo2">&nbsp;</td>
  </tr>
  <tr>
    <td class="Estilo2"><div>
      <div>DIAGNOSTICO:___________________________</div>
      </div></td>
  </tr>
</table>
...
<div align="right"><br />
  <br />
  <img src="{{ asset('assets/images/firma.png') }}" width="272" height="140" /></div>
</body>
</html>
