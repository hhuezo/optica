...
@section('content')
                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($sucursales as $item)
                                    ...
                                    @include('administracion.sucursal.edit')
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Nueva sucursal</h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            expandMenuAndHighlightOption('administracionMenu', 'sucursalOption');
