...
@section('content')
                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($bodegas as $item)
                                    ...
                                    @include('administracion.bodega.edit')
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Nueva bodega</h6>
                ...
                <form method="POST" action="{{ route('bodega.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label for="input-label" class="form-label">Sucursal:</label>
                                <select class="form-select" name="store_id">
                                    <option value="">Seleccione</option>
                                    @foreach ($sucursales as $sucursal)
                                        <option value="{{ $sucursal->id }}"
                                            {{ old('store_id') == $sucursal->id ? 'selected' : '' }}>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            expandMenuAndHighlightOption('administracionMenu', 'bodegaOption');
