...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Nueva Empresa</h6>
                                ...
                                <select class="form-select" name="company_category_id">
                                    @foreach ($sectores as $sector)
                                        <option value="{{ $sector->id }}"
                                            {{ old('company_category_id') == $sector->id ? 'selected' : '' }}>
                                            {{ $sector->name }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            expandMenuAndHighlightOption('administracionMenu', 'empresaOption');
