...
@section('content')
                            ...
                            <tbody>
                                @foreach ($datos as $fila)
                                    ...
                                    <tr>
                                        <td>{{ $fila->product }}</td>
                                        @foreach ($bodegas as $bodega)
                                            @php $cantidad = $fila->{'bodega_' . $bodega->id} @endphp
                                            <td>{{ $cantidad }}</td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            expandMenuAndHighlightOption('inventarioMenu', 'existenciaOption');
            ...
            $('#datatable-basic').DataTable({
                ...
                buttons: [{
                        ...
                        filename: 'existencias', // ← Nombre del archivo .xlsx
                        title: 'existencias' // ← Título dentro del Excel
                    },

                    {
                        ...
                        pageSize: 'A4',
                        filename: 'existencias', // ← Nombre del archivo .pdf
                        title: 'existencias', // ← Título dentro del PDF
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
